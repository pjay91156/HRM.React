    ...
    return (
        <div className="space-y-6 max-w-[1600px] mx-auto">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    <h1 className="text-2xl md:text-3xl font-bold tracking-tight text-slate-900">Departments</h1>
                    <p className="text-sm text-slate-500 mt-0.5">Manage and organize company business divisions</p>
                </div>
                <button 
                            ...
                            {filteredDepartments.map(dep => (
                                <tr key={dep.id} className="group hover:bg-slate-50/70 transition-colors duration-150">
                                    <td className="py-4 px-6">
                                        <div className="font-medium text-slate-900 text-sm">{dep.departmentName}</div>
                                    </td>
