...
const DeleteLeaveTypeModal: React.FC<DeleteLeaveTypeModalProps> = ({ isOpen, onClose, onConfirm, leaveTypeName }) => {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4 backdrop-blur-[1px]">
            <div className="w-full max-w-md rounded-xl bg-white dark:bg-slate-900 p-6 shadow-xl border border-gray-100 dark:border-slate-800">
                ...
                <p className="text-sm text-gray-600 dark:text-slate-400 mb-6">Are you sure you want to remove <span className="font-semibold">{leaveTypeName}</span>?</p>
